...
const (
	Auth_Register_FullMethodName = "/uth.Auth/Register"
	Auth_Login_FullMethodName    = "/uth.Auth/Login"
	Auth_IsAdmin_FullMethodName  = "/uth.Auth/IsAdmin"
)
